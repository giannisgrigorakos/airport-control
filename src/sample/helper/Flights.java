...
public class Flights {
    //here we store all our flights. The convention is [flightId, cityOfDeparture, flightType, planeType, whereParked, currentState, departureTime, firstContact, landingTime]
